...
cv2.imwrite('1. contrasted.png', contrasted)

ndvi = calc_ndvi(contrasted)
# display(ndvi, 'NDVI')
cv2.imwrite('2. ndvi.png', ndvi)

ndvi_contrasted = contrast_stretch(ndvi)
# display(ndvi_contrasted, 'NDVI Contrasted')
cv2.imwrite('3. ndvi_contrasted.png', ndvi_contrasted)

color_mapped_prep = ndvi_contrasted.astype(np.uint8)
color_mapped_image = cv2.applyColorMap(color_mapped_prep, fastiecm)
# display(color_mapped_image, 'Color mapped')
cv2.imwrite('4. color_mapped_image.png', color_mapped_image)

cv2.imwrite('0. original.png', original)